...
export default function ContactUsPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col overflow-x-hidden bg-rental-blue-900">
      ...
      <section className="w-full pb-12 md:pb-5 text-center">
        <div className="px-6 md:px-10 lg:px-[150px]">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-26 items-stretch pt-7 px-7">
            ...
            >
              ...
              <div className="relative z-10 md:pt-12 md:px-12 md:pb-5 flex flex-col h-full w-full items-center">
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white font-outfit mb-4 text-center">
                  Contact Us
                </h1>
                <p className="text-white font-outfit text-base md:text-lg leading-relaxed mb-8 max-w-md text-center">
            ...
            <div className="bg-white p-8 md:p-12 rounded-lg shadow-lg w-full flex flex-col">
              <h2 className="text-3xl md:text-4xl font-bold text-blue-900 font-outfit mb-2">
                Send us a Message
              </h2>
              ...
              <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
                ...
                <button 
                  type="submit" 
                  className="mt-2 rounded-lg bg-blue-900 px-8 py-3 font-outfit text-base font-semibold text-white transition-all hover:bg-blue-800 hover:shadow-lg"
                >
                  Send Message
                </button>
              </form>
      ...
      <section className="w-full pb-12 md:pb-16">
        <div className="px-6 md:px-10 lg:px-[150px]">
          ...
          >
            ...
            <div className="relative z-10 p-8 md:p-12 w-full min-h-[400px]">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {/* Left Side - Contact Information */}
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-white font-outfit mb-3">
                Contact Information
              </h2>
              <p className="text-white font-outfit text-base mb-8 opacity-90">
            ...
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-white font-outfit mb-8">
                Follow us on
              </h2>
