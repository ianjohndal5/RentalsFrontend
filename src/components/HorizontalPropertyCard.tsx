...
function HorizontalPropertyCard({
  ...
  return (
    <article className="horizontal-property-card">
      <img
        src={image}
        alt={title}
      ...
      <div className="horizontal-property-content">
        <div className="horizontal-property-header-row">
          <p className="horizontal-property-type">{propertyType}</p>
          <p className="horizontal-property-date">{date}</p>
        </div>
        ...
        <h3 className="horizontal-property-title">{title}</h3>
        <div className="horizontal-rent-manager-badge">
          ...
          />
          <div className="horizontal-rent-manager-info">
            <p className="horizontal-rent-manager-name">{rentManagerName}</p>
            <p className="horizontal-rent-manager-role">{rentManagerRole}</p>
          </div>
        </div>
