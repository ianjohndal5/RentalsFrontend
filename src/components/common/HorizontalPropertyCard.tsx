...
function HorizontalPropertyCard({
  ...
  return (
    <article
      ...
      className="w-full bg-white border border-gray-200 rounded-2xl overflow-hidden flex flex-col sm:flex-row items-stretch shadow-sm hover:shadow-md transition-all duration-200"
    >
      ...
      {/* Right: Content */}
      <div className="flex flex-col flex-1 p-5 sm:p-6 gap-3 sm:gap-4 min-w-0">
